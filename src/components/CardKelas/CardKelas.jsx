            ...
            <Row style={{ width: '100%'}} className="row-kelas">
                <Col className="d-flex flex-wrap justify-content-lg-start justify-content-md-center col-lg-7 col-md-12 gap-4">
                    <div className="card-container">
                        ...
                        <div className="card-kelas" style={{ backgroundColor: '#345CBB'}}>
                            <Card.Body>
                    ...
                    <div className="card-container">
                        ...
                        <div className="card-kelas" style={{ backgroundColor: '#F76761'}} >
                            <Card.Body>
                    ...
                    <div className="card-container">
                        ...
                        <div className="card-kelas" style={{ backgroundColor: '#F9BD67'}} >
                            <Card.Body>
                    ...
                    <div className="card-container">
                        ...
                        <div className="card-kelas" style={{ backgroundColor: '#94435C'}} >
                            <Card.Body>
