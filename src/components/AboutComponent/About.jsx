...
function About(){
    return (
        <React.Fragment>
            ...
            <img className="about-photo-icon" src={image}/>
            <Row className="p-5 mt-5" style={{ width: '100%' }}>
            ...
            <Row className="d-flex justify-content-end align-items-center" style={{ background: '#A7E3F34D', width: '100%', paddingTop: '10vh' }}>
            ...
            <Row className="px-5 pb-5 mb-5 d-flex justify-content-center align-items-center gap-4" style={{ width: '100%', paddingTop: '15vh' }}>
                <Col className="col-lg-3 d-flex justify-content-center align-items-center">
            ...
            <div className="about-deskripsi pb-5 mb5">
